    ...
    return (
        <>
          <div className='border-b-[1px] border-b-zinc-800 px-4 pb-4 flex flex-col gap-2 border-dotted lg:border-0'>
            ...
            <Link href='/#about' className='flex gap-3 text-lg font-bold items-center underline my-3 text-accent'>Learn More <FaArrowRight /></Link>
          </div>
          <div className='px-4 flex flex-col gap-2'>
            ...
            <Link href='/achievements' className='flex gap-3 text-lg font-bold items-center underline mt-3 text-accent'>Learn More <FaArrowRight /></Link>
          </div>
        </>
    )
}